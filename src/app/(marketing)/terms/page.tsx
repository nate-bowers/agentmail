...
const sections = [
  ...
  },
  {
    ...
    content: `Daily Brief is an AI-powered email newsletter service that delivers personalized daily briefings. Content is generated using Claude AI (Anthropic) and real-time web search. We do not guarantee the accuracy, completeness, or timeliness of AI-generated content.`,
  },
  {
    id: 'accounts',
  ...
  },
  {
    ...
    content: `You agree not to use Daily Brief to: circumvent technical limitations or access controls; scrape, reproduce, or resell AI-generated content for commercial purposes; submit false, misleading, or harmful configuration data; or violate any applicable local, state, national, or international laws or regulations.`,
  },
  {
    id: 'billing',
  ...
  {
    id: 'ai-disclaimer',
    title: '6. Content and AI Disclaimer',
    content: `Content delivered by Daily Brief is generated by artificial intelligence and may contain errors, inaccuracies, or outdated information. Daily Brief is not a financial advisor, medical advisor, news publisher, or professional service provider. Do not make important financial, medical, legal, or other significant decisions based solely on AI-generated content delivered through this service.`,
  },
  {
    id: 'ip',
    title: '7. Intellectual Property',
    content: `You retain ownership of your personal configuration data and preferences. Daily Brief retains ownership of the platform, branding, codebase, and underlying technology. AI-generated email content is provided for your personal, non-commercial use only and may not be redistributed or resold.`,
  },
  {
    id: 'termination',
    title: '8. Termination',
  ...
  },
  {
    ...
    content: `Daily Brief is provided "as is" without warranties of any kind, express or implied. To the fullest extent permitted by law, we are not liable for any damages arising from your use of the service, including but not limited to damages from inaccurate AI-generated content, service interruptions, or data loss.`,
  },
  {
    id: 'changes',
  ...
  },
  {
    id: 'contact',
    title: '11. Contact',
    content: `For questions about these Terms of Service, please contact us at: [add support email before launch]`,
  },
];
